...
Built: Sun  8 Feb 18:17:55 GMT 2026
Image Size: 708MB
...
app-arch/libarchive-3.8.5 | `acl bzip2 e2fsprogs iconv lzma xattr zstd -blake2 -expat -lz4 -lzo -nettle -static-libs -test -verify-sig`
...
dev-lang/perl-5.42.0-r1 | `-berkdb -doc -gdbm -minimal`
...
dev-libs/icu-78.2 | `-debug -doc -examples -static-libs -test -verify-sig`
...
media-libs/alsa-lib-1.2.15.3 | `-debug -doc -python -verify-sig`
media-libs/alsa-topology-conf-1.2.5.1-r1 | `-verify-sig`
media-libs/alsa-ucm-conf-1.2.15.3 | `-verify-sig`
...
media-sound/alsa-utils-1.2.15.2 | `libsamplerate nls -bat -doc -ieee1394 -ncurses (-selinux) -verify-sig`
media-video/ffmpeg-8.0.1 | `amr amrenc bzip2 drm fdk fontconfig gnutls gpl libass libsoxr opus truetype vorbis xml zlib -`
net-dns/bind-9.20.16 | ``
net-fs/cifs-utils-7.5 | `acl ads caps python -creds -pam -systemd`
net-fs/samba-4.23.4 | `acl regedit system-mitkrb5 -addc -ads -ceph -client -cluster -cups -debug (-fam) -glusterfs -gpg -iprint -json -ldap -llvm-libunwind -lmdb -pam -profiling-data -python -quota (-selinux) -snapper -spotlight -syslog (-system-heimdal) -systemd (-test) -unwind -winbind -zeroconf`
net-libs/gnutls-3.8.11 | `cxx idn nls openssl tls-heartbeat zlib -brotli -dane -doc -examples -pkcs11 (-sslv2) (-sslv3) -static-libs -systemtap -test -test-full -tools -verify-sig -zstd`
net-libs/ngtcp2-1.20.0 | `gnutls ssl (-openssl) -verify-sig`
...
sys-libs/liburing-2.13 | `-examples -static-libs -test`
sys-libs/talloc-2.4.3 | `python -compat -test -valgrind`
sys-libs/tdb-1.4.14 | `-python -test`
sys-libs/tevent-0.17.1 | `-python -test`
