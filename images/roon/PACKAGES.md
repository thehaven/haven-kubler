...
Built: Wed 23 Jul 20:32:36 BST 2025
Image Size: 674MB
...
media-video/ffmpeg-7.1.1-r2 | `amr amrenc bzip2 drm fdk fontconfig gnutls gpl libass postproc truetype vorbis xml zlib -`
net-dns/bind-9.20.10 | ``
net-fs/cifs-utils-7.0-r1 | `acl ads caps python -creds -pam -systemd`
net-fs/samba-4.20.8-r1 | `acl regedit system-mitkrb5 -addc -ads -ceph -client -cluster -cups -debug (-fam) -glusterfs -gpg -iprint -json -ldap -llvm-libunwind -pam -profiling-data -python -quota (-selinux) -snapper -spotlight -syslog (-system-heimdal) -systemd (-test) -unwind -winbind -zeroconf`
