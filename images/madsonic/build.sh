...
#     kubler.sh build -i thehaven/madsonic
...
finish_rootfs_build()
{
    ...
    #export DISTRIBUTION_DIR="${GOPATH}/src/github.com/thehaven/madsonic"
    #mkdir -p "${DISTRIBUTION_DIR}"

    #git clone https://github.com/thehaven/madsonic.git "${DISTRIBUTION_DIR}"
    #cd "${DISTRIBUTION_DIR}"
    #git checkout tags/v${_madsonic_version}
    #echo "building madsonic ${_madsonic_version}.."
    ...
    #log_as_installed "manual install" "madsonic-${_madsonic_version}" "https://madsonic.org/"
    :
}
