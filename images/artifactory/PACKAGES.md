...
Package | USE Flags
--------|----------
dev-util/artifactory-pro-bin-6.2.0 | `ssl`
#### Inherited
Package | USE Flags
--------|----------
...
dev-java/oracle-jdk-bin-1.8.0.192 | `fontconfig headless-awt jce -alsa -commercial -cups -doc -examples -javafx -nsplugin (-selinux) -source -visualvm`
