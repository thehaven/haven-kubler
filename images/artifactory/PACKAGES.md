...
Built: Fri  8 Nov 20:58:03 GMT 2019
Image Size: 773MB
...
dev-util/artifactory-pro-bin-6.14.0 | `ssl`
#### Inherited
Package | USE Flags
--------|----------
...
dev-java/oracle-jdk-bin-1.8.0.202 | `fontconfig headless-awt jce -alsa -commercial -cups -doc -examples -javafx -nsplugin (-selinux) -source -visualvm`
...
app-crypt/gnupg-2.2.17 | `bzip2 nls readline smartcard ssl -doc -ldap (-selinux) -tofu -tools -usb -user-socket -wks-server`
...
app-portage/portage-utils-0.80 | `nls openmp qmanifest qtegrity -libressl -static`
app-shells/bash-4.4_p23-r1 | `net nls (readline) -afs -bashlogger -examples -mem-scramble -plugins`
