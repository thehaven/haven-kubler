...
Built: Tue 16 Jun 10:19:33 BST 2020
Image Size: 742MB
...
dev-util/artifactory-pro-bin-6.19.1 | `ssl`
#### Inherited
Package | USE Flags
--------|----------
**FROM haven/jdk-openjdk** |
app-arch/bzip2-1.0.6-r11 | `(split-usr) -static -static-libs`
app-crypt/p11-kit-0.23.19-r1 | `asn1 libffi trust -debug`
app-eselect/eselect-fontconfig-1.1-r1 | ``
app-eselect/eselect-java-0.4.0 | ``
dev-java/java-config-2.2.0-r4 | `-test`
dev-java/openjdk-bin-11.0.7_p10 | `gentoo-vm headless-awt -alsa -cups -doc (-nsplugin) (-selinux) -source (-webstart)`
