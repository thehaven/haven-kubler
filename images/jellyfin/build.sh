...
#     kubler.sh build -i haven/jellyfin
...
finish_rootfs_build()
{
    ...
    #export DISTRIBUTION_DIR="${GOPATH}/src/github.com/haven/jellyfin"
    #mkdir -p "${DISTRIBUTION_DIR}"

    #git clone https://github.com/haven/jellyfin.git "${DISTRIBUTION_DIR}"
    #cd "${DISTRIBUTION_DIR}"
    #git checkout tags/v${_jellyfin_version}
    #echo "building jellyfin ${_jellyfin_version}.."
    ...
    #log_as_installed "manual install" "jellyfin-${_jellyfin_version}" "https://jellyfin.org/"
