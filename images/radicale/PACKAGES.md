...
dev-python/passlib-1.7.4-r4 | `(test-rust) -doc -test`
...
dev-db/sqlite-3.51.3 | `readline -debug -doc -icu -secure-delete -static-libs -tcl -test -test-full -tools`
...
dev-libs/expat-2.7.5 | `unicode -examples -static-libs -test`
...
dev-python/charset-normalizer-3.4.6 | `native-extensions -debug -test -verify-provenance`
...
dev-python/jaraco-text-4.2.0 | `-test`
...
dev-python/platformdirs-4.9.4 | `-test -verify-provenance`
dev-python/pygments-2.19.2 | `-test`
dev-python/pyproject-hooks-1.2.0 | `-test`
dev-python/pysocks-1.7.1-r2 | ` `
dev-python/requests-2.32.5-r1 | `(test-rust) -socks5 -test`
dev-python/resolvelib-1.2.1 | `-test`
dev-python/rich-14.3.3 | `-test`
dev-python/setuptools-81.0.0 | `-test`
dev-python/setuptools-scm-10.0.1 | `-test -verify-provenance`
...
dev-python/vcs-versioning-1.0.1 | `-test`
dev-python/wheel-0.46.3 | `-test -verify-provenance`
sys-apps/util-linux-2.41.3-r1 | `caps cramfs hardlink nls readline suid tty-helpers (unicode) -audit -build -cryptsetup -fdformat -kill -logger -magic -ncurses -pam -python (-rtas) (-selinux) -slang -static-libs -su -systemd -test -udev -uuidd -verify-sig`
...
net-libs/ngtcp2-1.21.0 | `openssl ssl -gnutls -verify-sig`
net-misc/curl-8.19.0 | `adns alt-svc ftp hsts http2 http3 httpsrr imap openssl pop3 psl quic smtp ssl tftp websockets -brotli -debug -ech -gnutls -gopher -idn -kerberos -ldap -mbedtls -rtmp -rustls -samba -sasl-scram -ssh -static-libs -telnet -test -verify-sig -zstd`
sys-apps/acl-2.3.2-r3 | `nls -static-libs`
...
sys-apps/file-5.47-r1 | `bzip2 seccomp zlib -lzip -lzma -python -static-libs -verify-sig -zstd`
...
dev-libs/openssl-3.5.5-r2 | `asm quic -fips -ktls -rfc3779 -sctp -static-libs -test -tls-compression -vanilla -verify-sig -weak-ssl-ciphers`
**FROM haven/s6** |
